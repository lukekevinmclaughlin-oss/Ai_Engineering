...
exports.default=async context=>{
  ...
  await rcedit(path.join(context.appOutDir,info.productFilename+'.exe'),{
    ...
    'version-string':{CompanyName:'Luke McLaughlin',FileDescription:'AI engineering courses, projects and tutoring for Windows',ProductName:info.productName,OriginalFilename:info.productFilename+'.exe'}
  });
};
